...
CREATE TABLE `letter_grades` (
  ...
  `d_minus_count` int(11) DEFAULT NULL,
  `f_count` int(11) DEFAULT NULL,
  `average_gpa` int(11) DEFAULT NULL,
  PRIMARY KEY (`c_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `letter_grades`
--

LOCK TABLES `letter_grades` WRITE;
/*!40000 ALTER TABLE `letter_grades` DISABLE KEYS */;
/*!40000 ALTER TABLE `letter_grades` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-04-08 18:31:31
